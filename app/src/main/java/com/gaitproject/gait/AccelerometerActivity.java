...
public class AccelerometerActivity extends Activity implements SensorEventListener{
    ...
    private void updateTextView(Acceleration capturedAcceleration) {
        acceleration.setText("X:" + capturedAcceleration.getX() +
                ...
                "\nUserId:" + capturedAcceleration.getUserid());
    }
    ...
    private Acceleration getAccelerationFromSensor(SensorEvent event) {
        ...
        long deviceId = Long.valueOf(telephonyManager.getDeviceId());

        return new Acceleration(event.values[0], event.values[1], event.values[2], timestamp, deviceId);
    }
